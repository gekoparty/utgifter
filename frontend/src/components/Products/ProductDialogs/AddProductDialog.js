...
const predefinedTypes = ["Matvare", "Gambling", "Gave","Ferje", "Reise", "Hår/Hud","Ferdigmat", "Brev/Pakke","Jernvare", "Elektronikk", "Bil", "Artikler", "Klær", "Verktøy", "Tobakk"]; // Add your predefined types here
